var photos = [
    ...
    "https://upload.wikimedia.org/wikipedia/commons/e/ec/American_Horror_Story.svg"
];

$("body").append("<img src=" + photos[0] + ">");
$("body").append("<img src=" + photos[1] + ">");
$("body").append("<img src=" + photos[2] + ">");
$("body").append("<img src=" + photos[3] + ">");
$("body").append("<img src=" + photos[4] + ">");
